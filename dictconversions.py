...
df = pandas.DataFrame(data = data, index = ('COUNTRY', 'POP', 'AREA', 'GDP', 'CONT', 'IND_DAY')).T
# print(df)

#imports data to csv file
csv_data = df.to_csv('csvfile.csv')

#reads data from csv files
read_csv = pandas.read_csv('csvfile.csv', skiprows=range(2,10,2))
print(read_csv)

#imports data to json file
json_data = df.to_json('jsonfile.json')
